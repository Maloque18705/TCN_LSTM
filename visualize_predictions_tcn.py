...
# 1. THAY ĐỔI: Import model TCN mới
...
def main():
    ...
    # 2. THAY ĐỔI: Cập nhật custom_objects
    # Cần thiết để Keras biết 'TCN_Model' và 'ResidualBlock' là gì khi tải
    ...
    try:
        ...
        print("Tip: Ensure 'Model/tcn.py' is in your PYTHONPATH.")
        sys.exit(1)
    ...
    dp = DataProcess()
    # Sử dụng case_index từ config (hoặc 0 nếu bạn muốn)
